...
int i86_gdt_initialize () {
  ...
  //code
  gdt_set_descriptor (1,0,0xffffffff, GDT_RW|GDT_EXE|GDT_CDT|GDT_MEM, GDT_GR_PG|GDT_GR_32|GDT_GR_HI);
  //data
  gdt_set_descriptor (2,0,0xffffffff, GDT_RW|GDT_CDT|GDT_MEM, GDT_GR_PG|GDT_GR_32|GDT_GR_HI);
  gdt_install();  
  return 0;
}
